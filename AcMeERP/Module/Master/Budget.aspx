<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/HomeLoginMaster.Master"
    AutoEventWireup="true" CodeBehind="Budget.aspx.cs" Inherits="AcMeERP.Module.Master.Budget"
                        ...
                        <ClientSideEvents Click="function(s, e)
                                {
                                  ...
                                  {
                                    window.open('/Report/ReportDownload.aspx?rid=RPT-177&type=pdf');
                        ...
                        <ClientSideEvents Click="function(s, e)
                                {
                                  ...
                                  if (e.processOnServer)
                                  {
                                    window.open('/Report/ReportDownload.aspx?rid=RPT-177&type=xls');
                                    e.processOnServer =false;
                                  }
                                 }" />
                    </dx:ASPxButton>
                ...
                <div>
                    <dx:ASPxGridView ID="gvBudgetView" runat="server" AutoGenerateColumns="False" KeyFieldName="LEDGER_ID"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Budget Group" FieldName="GROUP_FOR_GRID" Name="colBudgetGroup"
                                VisibleIndex="7" Width="5%" GroupIndex="1">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn Caption="HO Narration" FieldName="HO_NARRATION"
                                Name="colHONarration" VisibleIndex="14" Width="10%">
                                <DataItemTemplate>
