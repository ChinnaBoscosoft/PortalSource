...
{
    public partial class HeadOfficeListBranchOfficeDetailed : Base.UIBase
    {
        #region Declaration
        ...
        protected void aspxBtnExcel_Click(object sender, EventArgs e)
        {
            ...
            xlsexport.SheetName = "Head_Office_wise_Branch_Office_detailed";
            this.gridHOwiseBranchList.WriteXlsToResponse("Head_Office_wise_Branch_Office_detailed", true, xlsexport);
        }
        ...
        private void LoadHOwiseBranch()
        {
            try
            {
                using (BranchOfficeSystem branchsystem = new BranchOfficeSystem())
                {
                    ...
                    {
                        resultArgs = branchsystem.FetchHeadOfficewiseBranchOfficeDetailed();
                    ...
                    if (resultArgs != null && resultArgs.Success)
                    {
                        ...
                        gvHOwiseBranchlistdetailed.DataSource = resultArgs.DataSource.Table;
                        gvHOwiseBranchlistdetailed.DataBind();
                    }
                }
            }
            catch (Exception ex)
