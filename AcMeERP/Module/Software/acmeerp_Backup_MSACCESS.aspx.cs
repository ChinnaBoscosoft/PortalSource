...
{
    public partial class acmeerp_Backup_MSACCESS : Base.UIBase
    {
        // test
        #region Declaration
        ...
        //string dbuloadDBpath = @"D:\APP Source\NewPortal\AcMeERPPortal\AcMeERP\Module\Software\Uploads\AcMEERPBackupSDBINM\sdbinmms\";
        string dbuloadDBpath = @"C:\Inetpub\vhosts\acmeerp.org\httpdocs\Module\Software\Uploads\AcMEERPBackupSDBINM\sdbinmms\";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.PageTitle = "Acme.erp Backup Access Database";
        ...
        private void LoadBackupFiles()
        {
            try
            {
                ...
                string userBackupPath = Path.Combine(dbuloadDBpath, base.LoginUser.HeadOfficeCode + "ms");
                ...
                foreach (string path in filesPath)
                {
                    ...
                    dr["PhysicalFile"] = "https://www.acmeerp.org/Module/Software/" + Bosco.Utility.CommonMember.DOWNLOAD_FOLDER + "AcMEERPBackupSDBINM/" + base.LoginUser.HeadOfficeCode + "ms" + "/" + Path.GetFileName(path);
        ...
        protected void aspxUploadBrowsefile_FileUploadComplete(object sender, FileUploadCompleteEventArgs e)
        {
            try
            {
                if (e.UploadedFile.IsValid)
                {
                    ...
                    if (!fileExtension.Equals(".mdb", StringComparison.OrdinalIgnoreCase) &&
                        !fileExtension.Equals(".accdb", StringComparison.OrdinalIgnoreCase))
                    {
                        this.Message = "Invalid file type. Please upload .mdb or .accdb files only.";
                        return;
                    }
