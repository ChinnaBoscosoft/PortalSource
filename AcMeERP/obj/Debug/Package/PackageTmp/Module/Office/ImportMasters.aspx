<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/HomeLoginMaster.Master"
    AutoEventWireup="true" CodeBehind="ImportMasters.aspx.cs" Inherits="AcMeERP.Module.Office.ImportMasters" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMain" runat="server">
    <div class="div100">
        <dx:ASPxLabel ID="lblMessage" runat="server" Text="" ForeColor="Red">
        </dx:ASPxLabel>
    </div>
    <br />
    <div class="row-fluid">
        <div class="span10 offset1">
            <div class="row-fluid">
                <div class="floatright red">
                    <span style="">Download the Masters Template Here</span>
                    <asp:ImageButton ID="imgDownloadMastersTempleate" OnClick="imgDownloadMastersTempleate_Click"
                        runat="server" AlternateText="DownloadMastersTemplate" ToopTip="Click to Download Masters Template"
