<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/HomeLoginMaster.Master"
    AutoEventWireup="true" CodeBehind="ProjectMapping.aspx.cs" Inherits="AcMeERP.Module.Office.ProjectMapping"
    ...
    <div class="criteriaribben">
        <div>
            ...
            <div class="floatright">
                <span class="bold">
                    <dx:ASPxButton ID="btnMapLocation" OnClick="btnMapLocation_Click" runat="server"
                        Height="20px" Theme="Office2010Blue" Text="Map Locations" ToolTip="Click here Map Locations to projects">
                    </dx:ASPxButton>
                </span>
            </div>
        </div>
    ...
    <div>
        <dx:ASPxGridView ID="gvProject" runat="server" Width="100%" KeyFieldName="PROJECT_ID"
            ...
            <Columns>
                ...
                <%-- <dx:GridViewDataTextColumn Name="colLocation" VisibleIndex="4" Width="170px" Caption="Location" FieldName="LOCATION_ID"
                    Visible="true">
