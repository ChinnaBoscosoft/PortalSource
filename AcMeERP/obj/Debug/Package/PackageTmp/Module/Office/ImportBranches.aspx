<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/HomeLoginMaster.Master"
    AutoEventWireup="true" CodeBehind="ImportBranches.aspx.cs" Inherits="AcMeERP.Module.Office.ImportBranches" %>
        ...
        <div class="span10 offset1">
            <div class="row-fluid">
                <div class="floatright red">
                    <span style="">Download the Branch Office Template Here</span>
                    <asp:ImageButton ID="imgDownloadBranchTempleate" OnClick="imgDownloadBranchTempleate_Click"
                        runat="server" AlternateText="DownloadBranchTemplate" CausesValidation="False"
                        SkinID="download_bt" />
                </div>
            </div>
            <div class="row-fluid">
