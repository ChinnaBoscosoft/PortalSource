...
{
    public partial class BranchLocationIEYearWise : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor

        public BranchLocationIEYearWise()
        {
            InitializeComponent();
        ...
        public void BindReport()
        {
            ...
            xrCellCapY1.Text = "FY " + dtfrom.ToString("yyyy") + " - " + dtto.ToString("yy");
            xrCellCapY2.Text = "FY " + dtfrom.AddYears(-1).ToString("yyyy") + " - " + dtto.AddYears(-1).ToString("yy");
            xrCellCapY3.Text = "FY " + dtfrom.AddYears(-2).ToString("yyyy") + " - " + dtto.AddYears(-2).ToString("yy");
            xrCellCapY4.Text = "FY " + dtfrom.AddYears(-3).ToString("yyyy") + " - " + dtto.AddYears(-3).ToString("yy");
            xrCellCapY5.Text = "FY " + dtfrom.AddYears(-4).ToString("yyyy") + " - " + dtto.AddYears(-4).ToString("yy");
            xrCellCapY6.Text = "FY " + dtfrom.AddYears(-5).ToString("yyyy") + " - " + dtto.AddYears(-5).ToString("yy");
        ...
        private ResultArgs GetReportSource()
        {
            ...
            string sqlBranchFixedAssetInvestments = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.BranchLocationIEYearWise);
            string liquidityGroupIds = this.GetLiquidityGroupIds();

            using (DataManager dataManager = new DataManager(SQL.ReportSQLCommand.FinalAccounts.BranchLocationIEYearWise, DataBaseType.HeadOffice))
            {
