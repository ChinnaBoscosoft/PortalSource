...
{
    public partial class ForeignInstitutionDetails : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor
        public ForeignInstitutionDetails()
        {
            InitializeComponent();
        ...
        public void BindSource()
        {
            ...
            xrTableHeader.WidthF = xrTableDetails.WidthF=xrGrandTotal.WidthF = 1000.25f;
            SetReportTitle();
