        ...
        public void BindReceiptPaymentsSource()
        {
            ...
            else
            {
                ...
                if (ReportProperties.ShowGroupCode == 1)    // Need to Include the Parent Group also to set the width
                {
                    ...
                    accountBalance.NameHeaderColumWidth = ReceiptNameWidth + ReceiptCodeWidth;    // ReceiptNameWidth;
                    accountBalance.NameColumnWidth = ReceiptNameWidth + ReceiptCodeWidth;
                ...
                {//
                    ...
                    else
                    {
                        ...
                        accountClosingBalance.AmountColumnWidth = PaymentAmountWidth + 11;// aldrin
                ...
                else
                {
                    ...
                    else if (ReportProperties.ShowByLedger == 1)
                    {
                        ...
                        paymentLedgers.GroupNameColumnWidth = paymentLedgers.ParentGroupColumWidth = ReceiptCodeWidth + PaymentNameWidth;
                        paymentLedgers.GroupAmountColumnWidth = paymentLedgers.ParentGroupAmountColumnWidth = PaymentAmountWidth - 2;
                        accountClosingBalance.AmountHeaderColumWidth = PaymentAmountWidth + 10;
