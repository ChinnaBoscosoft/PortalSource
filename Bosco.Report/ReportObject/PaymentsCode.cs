...
{
    public partial class PaymentsCode : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor
        public PaymentsCode()
        {
        ...
        private ResultArgs SetReportReceiptSource(TransType transType)
        {
            ...
            {
                sqlPayments = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.PaymentsCode);
                sqlCommandId = SQL.ReportSQLCommand.FinalAccounts.PaymentsCode;
            ...
            using (DataManager dataManager = new DataManager(sqlCommandId, DataBaseType.HeadOffice))
            {
                ...
                dataManager.Parameters.Add(this.ReportParameters.SHOW_GENERALATEColumn, this.ReportProperties.ReportCodeType);
        ...
        private void SetReportSetting()
        {
            ...
            if (grpParentGroup.Visible)
            {
                ...
                {
                    grpParentGroup.GroupFields[0].FieldName = reportSetting1.Payments.PARENT_GROUPColumn.ColumnName; // "PARENT_CODE1"; 
                }
                else
                {
                    grpParentGroup.GroupFields[0].FieldName = reportSetting1.Payments.PARENT_GROUPColumn.ColumnName; // "PARENT_CODE1"
            ...
            if (grpPaymentGroup.Visible)
            {
                ...
                {
                    grpPaymentGroup.GroupFields[0].FieldName = reportSetting1.Payments.GROUP_CODEColumn.ColumnName; //reportSetting1.Payments.LEDGER_GROUPColumn.ColumnName;
                }
                else
                {
                    grpPaymentGroup.GroupFields[0].FieldName = reportSetting1.Payments.GROUP_CODEColumn.ColumnName;  //reportSetting1.Payments.LEDGER_GROUPColumn.ColumnName;
            ...
            tcParentGroupCode.Visible = xrPaymentGroupCode.Visible = (this.LoginUser.IS_CMFCHE_CONGREGATION || this.LoginUser.IS_SAP_CONGREGATION) ? true : false;
        ...
        public void SortByLedgerorGroup()
        {
            if (grpParentGroup.Visible)
            {
                if (this.ReportProperties.SortByGroup == 0)
                {
                    ...
                    grpParentGroup.SortingSummary.FieldName = "PARENT_CODE1";
            ...
            if (grpPaymentGroup.Visible)
            {
                if (this.ReportProperties.SortByGroup == 0)
                {
                    ...
                    grpPaymentGroup.SortingSummary.FieldName = "GROUP_CODE";
            ...
            // grpPaymentLedger.SortingSummary.FieldName = string.Empty;
            grpPaymentLedger.SortingSummary.FieldName = "LEDGER_CODE";
            ...
            //            grpPaymentLedger.SortingSummary.FieldName = "GROUP_CODE";
