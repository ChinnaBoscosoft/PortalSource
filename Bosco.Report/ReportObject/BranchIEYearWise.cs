...
{
    public partial class BranchIEYearWise : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor

        public BranchIEYearWise()
        {
            InitializeComponent();
        ...
        private ResultArgs GetReportSource()
        {
            ...
            string sqlBranchFixedAssetInvestments = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.BranchIEYearWise);
            ...
            using (DataManager dataManager = new DataManager(SQL.ReportSQLCommand.FinalAccounts.BranchIEYearWise, DataBaseType.HeadOffice))
            {
