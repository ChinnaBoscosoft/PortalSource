...
{
    public partial class BalanceSheetAssetsSAP : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public void BindBalanceSheetAsset(DataTable dtAssetLedgers)
        {
            try
            {
                ...
                if (dtAssetLedgers != null)
                {
                    ...
                    accountBalance.NameColumnWidth = tcAssetLedgerName.WidthF + tcLedgerCode.WidthF;
                    accountBalance.AmountColumnWidth = tcAssetLedgerAmt.WidthF;
                    accountBalance.GroupNameWidth = tcAssetLedgerName.WidthF + tcLedgerCode.WidthF;
