...
{
    public partial class GeneralateBalanceSheetLiabilities1 : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        #region Constructor
        public GeneralateBalanceSheetLiabilities1()
        {
            InitializeComponent();
        ...
        public void BindBalanceSheetLiability()
        {
            try
            {
        ...
        private void SetReportSetting(DataView dvLiabilities)
        {
