...
{
    public partial class BalanceSheetSAP : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        {
            string BalanceSheet = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.BalanceSheetSAP);
        ...
        public void BindSubReportSource()
        {
            ...
            if (resultArgs.Success)
            {
                ...
                BalanceSheetLiabilitiesSAP liabilities = xrSubLiabilities.ReportSource as BalanceSheetLiabilitiesSAP;
                ...
                BalanceSheetAssetsSAP Asset = xrsubAssets.ReportSource as BalanceSheetAssetsSAP;
