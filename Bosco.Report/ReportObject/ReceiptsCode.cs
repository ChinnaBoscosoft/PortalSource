...
{
    public partial class ReceiptsCode : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor
        public ReceiptsCode()
        {
        ...
        {
            this.ReportProperties.ShowGroupCode = (LoginUser.IS_CMFCHE_CONGREGATION || LoginUser.IS_SAP_CONGREGATION) ? 1 : 0;
            ...
            {
                sqlReceipts = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.ReceiptsCode);
                sqlCommandId = SQL.ReportSQLCommand.FinalAccounts.ReceiptsCode;
        ...
        private void SetReportSetting()
        {
            ...
            if (grpParentGroup.Visible)
            {
                ...
                {
                    grpParentGroup.GroupFields[0].FieldName = reportSetting1.Receipts.PARENT_GROUPColumn.ColumnName; // "PARENT_CODE1";
                }
                else
                {
                    grpParentGroup.GroupFields[0].FieldName = reportSetting1.Receipts.PARENT_GROUPColumn.ColumnName; // "PARENT_CODE1";
            ...
            if (grpReceiptGroup.Visible)
            {
                if (ReportProperties.ShowByLedgerGroup == 1)
                {
                    grpReceiptGroup.GroupFields[0].FieldName = reportSetting1.Receipts.GROUP_CODEColumn.ColumnName; //reportSetting1.Receipts.LEDGER_GROUPColumn.ColumnName;
                }
                else
                {
                    grpReceiptGroup.GroupFields[0].FieldName = reportSetting1.Receipts.GROUP_CODEColumn.ColumnName; //reportSetting1.Receipts.LEDGER_GROUPColumn.ColumnName;
            ...
            xrParentGroupCode.Visible = xrGroupCode.Visible = (this.LoginUser.IS_CMFCHE_CONGREGATION || this.LoginUser.IS_SAP_CONGREGATION) ? true : false;
        ...
        public void SortByLedgerorGroup()
        {
            ...
            if (grpReceiptGroup.Visible)
            {
                if (this.ReportProperties.SortByGroup == 0)
                {
                    ...
                    grpReceiptGroup.SortingSummary.FieldName = "GROUP_CODE";
            ...
            //grpReceiptLedger.SortingSummary.FieldName = string.Empty;
