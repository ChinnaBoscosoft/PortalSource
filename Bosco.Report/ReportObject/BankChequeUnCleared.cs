...
namespace Bosco.Report.ReportObject
{
    public partial class BankChequeUnCleared : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        {
            InitializeComponent();
            /*this.AttachDrillDownToRecord(xrTable1, xrParticulars,
        ...
        private ResultArgs GetReportSource()
        {
            try
            {
                ...
                using (DataManager dataManager = new DataManager(SQL.ReportSQLCommand.BankReport.ChequeUncleared,DataBaseType.HeadOffice))
                {
        ...
        private void setReportBorder()
        {
            ...
            xrTable1 = SetBorders(xrTable1, ReportProperties.ShowHorizontalLine, ReportProperties.ShowVerticalLine);
